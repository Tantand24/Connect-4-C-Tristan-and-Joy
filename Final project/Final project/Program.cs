    ...
    public void mainGameloop()
    {
        while (!isWinOrTie())
        {
            try
            {
                ...
                if (Aiplayer1 != null && Aiplayer2 != null)
                {
                    if (_currentplayer == Aiplayer1.Name)
                    {
                        Aiplayer1.SetGameState(gameBoard, Aiplayer2);
                    ...
                    {
                        Aiplayer1.SetGameState(gameBoard, Aiplayer1);
                        gameBoard.Update(Aiplayer1.GetMove(), Aiplayer2);
                        if (isWinOrTie())
                        {
                            break;
                        }
